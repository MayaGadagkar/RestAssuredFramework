...
public class CreateBookingTest extends BaseTest {
  ...
  @Test
	public void createBookingTest()
	{
		...
		System.out.println("First name is :" + bookingresponse.getBooking().getFirstname());
		Assert.assertEquals(bookingresponse.getBooking().getFirstname(), bookingPayLoad.getFirstname());
		Assert.assertEquals(bookingresponse.getBooking().getLastname(), bookingPayLoad.getLastname());
	}
}
